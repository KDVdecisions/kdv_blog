...
1.  Attempt to obtain all observations of invasive plants within the Tahoe National Forest by splitting the bounding box into quarters and querying the Current Invasive Species Locations APIs for each individual quarter.

+ Obtain the bounding box of the Tahoe National and convert it into a polygon with `st_as_sfc()`
